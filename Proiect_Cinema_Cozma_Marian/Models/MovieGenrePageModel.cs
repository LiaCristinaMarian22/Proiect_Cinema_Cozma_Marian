...
namespace Proiect_Cinema_Cozma_Marian.Models
{
    public class MovieGenrePageModel : PageModel
    {
        ...
        public void PopulateAssignedGenreData(Proiect_Cinema_Cozma_MarianContext context,
        Movie movie)
        {
        ...
        public void UpdateMovieGenres(Proiect_Cinema_Cozma_MarianContext context,
